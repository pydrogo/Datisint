Ext.define('prada.page.views.Partner', {
    extend: 'hussein.grid.Panel',
    requires: ['prada.page.models.Partner'],
    title: 'مدیریت Analog BOX Camera',
    forceFit: true,
    searchbar: 'prada.page.views.Partner.SearchBar',
    columns: [
    {
        ...
        handler: function (grid, rowIndex, colIndex, actionItem, event, record) {
            Ext.create('Ext.window.Window', {
                ...
                modal: true,
                constrain: true,
                items: Ext.create('prada.page.views.PartnerForm', {
                    values: record.data
                ...
                fn: function (col, grid, record) {
                    return function (btn) {
                        if (btn == 'yes') {
                            Ext.Ajax.request({
                                method: 'delete',
                                url: 'PartnerAdmin/Delete/' + record.data.Id,
    ...
    model: 'prada.page.models.Partner',
    readUrl: 'PartnerAdmin/AjaxRead',
    tbar: [{
        iconCls: 'icon-Add',
        text: 'جدید',
...
Ext.define('prada.page.views.PartnerForm', {
    extend: 'Ext.container.Container',
    rtl: false,
    layout: 'border',
    items: [{
        url: 'PartnerAdmin/Save',
        xtype: 'form',
        border: false,
        region: 'center',
        autoScroll: true,
...
Ext.define('prada.page.views.Partner.SearchBar', {
