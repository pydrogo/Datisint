Ext.define('prada.page.views.AnalogIrDome', {
    extend: 'hussein.grid.Panel',
    requires: ['prada.page.models.AnalogIrDome'],
    title: 'مدیریت Analog IrDome Camera',
    forceFit: true,
    searchbar: 'prada.page.views.AnalogIrDome.SearchBar',
    columns: [
    {
        xtype: 'rownumberer'
    }, {
        ...
        },
        {
            ...
            handler: function (grid, rowIndex, colIndex, actionItem, event, record) {
                Ext.create('Ext.window.Window', {
                    ...
                    modal: true,
                    constrain: true,
                    items: Ext.create('prada.page.views.AnalogIrDomeForm', {
                        values: record.data
                    ...
                    fn: function (col, grid, record) {
                        return function (btn) {
                            if (btn == 'yes') {
                                Ext.Ajax.request({
                                    method: 'delete',
                                    url: 'AnalogIrDomeAdmin/Delete/' + record.data.Id,
    ...
    model: 'prada.page.models.AnalogIrDome',
    readUrl: 'AnalogIrDomeAdmin/AjaxRead',
    tbar: [{
        iconCls: 'icon-Add',
        text: 'جدید',
...
Ext.define('prada.page.views.AnalogIrDomeForm', {
    extend: 'Ext.container.Container',
    rtl: false,
    layout: 'border',
    items: [{
        url: 'AnalogIrDomeAdmin/Save',
        xtype: 'form',
        border: false,
        region: 'center',
        autoScroll: true,
...
Ext.define('prada.page.views.AnalogIrDome.SearchBar', {
