Ext.define('prada.page.views.AnalogIrBullet', {
    extend: 'hussein.grid.Panel',
    requires: ['prada.page.models.AnalogIrBullet'],
    title: 'مدیریت Analog IrBulet Camera',
    forceFit: true,
    searchbar: 'prada.page.views.AnalogIrBullet.SearchBar',
    columns: [
    {
        xtype: 'rownumberer'
    }, {
        ...
        },
        {
            ...
            handler: function (grid, rowIndex, colIndex, actionItem, event, record) {
                Ext.create('Ext.window.Window', {
                    ...
                    modal: true,
                    constrain: true,
                    items: Ext.create('prada.page.views.AnalogIrBulletForm', {
                        values: record.data
                    ...
                    fn: function (col, grid, record) {
                        return function (btn) {
                            if (btn == 'yes') {
                                Ext.Ajax.request({
                                    method: 'delete',
                                    url: 'AnalogIrBulletAdmin/Delete/' + record.data.Id,
    ...
    model: 'prada.page.models.AnalogIrBullet',
    readUrl: 'AnalogIrBulletAdmin/AjaxRead',
    tbar: [{
        iconCls: 'icon-Add',
        text: 'جدید',
...
Ext.define('prada.page.views.AnalogIrBulletForm', {
    extend: 'Ext.container.Container',
    rtl: false,
    layout: 'border',
    items: [{
        url: 'AnalogIrBulletAdmin/Save',
        xtype: 'form',
        border: false,
        region: 'center',
        autoScroll: true,
...
Ext.define('prada.page.views.AnalogIrBullet.SearchBar', {
