Ext.define('prada.page.views.AHDIrDome', {
    extend: 'hussein.grid.Panel',
    requires: ['prada.page.models.AHDIrDome'],
    title: 'مدیریت Network Dome Camera',
    forceFit: true,
    searchbar: 'prada.page.views.AHDIrDome.SearchBar',
    columns: [
    {
        xtype: 'rownumberer'
    }, {
        ...
        },
        {
            ...
            handler: function (grid, rowIndex, colIndex, actionItem, event, record) {
                Ext.create('Ext.window.Window', {
                    ...
                    modal: true,
                    constrain: true,
                    items: Ext.create('prada.page.views.AHDIRDomeForm', {
                        values: record.data
                    ...
                    fn: function (col, grid, record) {
                        return function (btn) {
                            if (btn == 'yes') {
                                Ext.Ajax.request({
                                    method: 'delete',
                                    url: 'AHDIrDomeAdmin/Delete/' + record.data.Id,
    ...
    model: 'prada.page.models.AHDIrDome',
    readUrl: 'AHDIrDomeAdmin/AjaxRead',
    tbar: [{
        iconCls: 'icon-Add',
        text: 'جدید',
...
Ext.define('prada.page.views.AHDIRDomeForm', {
    extend: 'Ext.container.Container',
    rtl: false,
    layout: 'border',
    items: [{
        url: 'AHDIrDomeAdmin/Save',
        xtype: 'form',
        border: false,
        region: 'center',
        autoScroll: true,
...
Ext.define('prada.page.views.AHDIrDome.SearchBar', {
