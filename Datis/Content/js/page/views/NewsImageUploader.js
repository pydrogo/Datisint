Ext.define('prada.page.views.NewsImageUploader', {
        ...
        render: function () {
            ...
            var uploader = $("#uploader").plupload({
                ...
                multipart_params: {
                    ...
                    MainOrLogoOrDimension: form.findField('MainLogoDimension').getValue()
                },
                init: {
            ...
            $.ajax({
                ...
                data:
                {
                    ...
                    "tableId": form.findField('tableId').getValue(),
                    "productId": form.findField('Id').getValue(),
                    "typeOfFileOrImage": form.findField('MainLogoDimension').getValue()
                },
