Ext.define('prada.page.views.About', {
    extend: 'hussein.grid.Panel',
    requires: ['prada.page.models.About'],
    title: 'مدیریت Analog BOX Camera',
    forceFit: true,
    searchbar: 'prada.page.views.About.SearchBar',
    columns: [
    {
        ...
        handler: function (grid, rowIndex, colIndex, actionItem, event, record) {
            Ext.create('Ext.window.Window', {
                ...
                modal: true,
                constrain: true,
                items: Ext.create('prada.page.views.AboutForm', {
                    values: record.data
                ...
                fn: function (col, grid, record) {
                    return function (btn) {
                        if (btn == 'yes') {
                            Ext.Ajax.request({
                                method: 'delete',
                                url: 'AboutAdmin/Delete/' + record.data.Id,
    ...
    model: 'prada.page.models.About',
    readUrl: 'AboutAdmin/AjaxRead',
    tbar: [{
        iconCls: 'icon-Add',
        text: 'جدید',
...
Ext.define('prada.page.views.AboutForm', {
...
Ext.define('prada.page.views.About.SearchBar', {
