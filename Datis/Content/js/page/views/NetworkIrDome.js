Ext.define('prada.page.views.NetworkIrDome', {
    extend: 'hussein.grid.Panel',
    requires: ['prada.page.models.NetworkIrDome'],
    title: 'مدیریت Network Dome Camera',
    forceFit: true,
    searchbar: 'prada.page.views.NetworkIrDome.SearchBar',
    columns: [
    {
        xtype: 'rownumberer'
    }, {
                    ...
                    fn: function (col, grid, record) {
                        return function (btn) {
                            if (btn == 'yes') {
                                Ext.Ajax.request({
                                    method: 'delete',
                                    url: 'NetworkIrDomeAdmin/Delete/' + record.data.Id,
    ...
    model: 'prada.page.models.NetworkIrDome',
    readUrl: 'NetworkIrDomeAdmin/AjaxRead',
    tbar: [{
        iconCls: 'icon-Add',
        text: 'جدید',
...
Ext.define('prada.page.views.NetworkIrDome.SearchBar', {
