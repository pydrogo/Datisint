Ext.define('prada.page.views.TermsOfGarranty', {
    extend: 'hussein.grid.Panel',
    requires: ['prada.page.models.TermsOfGarranty'],
    title: 'مدیریت برند',
    forceFit: true,
    searchbar: 'prada.page.views.TermsOfGarranty.SearchBar',
    columns: [
    {
        text: 'ردیف',
        xtype: 'rownumberer'
    ...
    },
        {
            ...
            handler: function (grid, rowIndex, colIndex, actionItem, event, record) {
                Ext.create('Ext.window.Window', {
                    ...
                    modal: true,
                    constrain: true,
                    items: Ext.create('prada.page.views.TermsOfGarrantyForm', {
                        values: record.data
                    ...
                    fn: function (col, grid, record) {
                        return function (btn) {
                            if (btn == 'yes') {
                                Ext.Ajax.request({
                                    method: 'delete',
                                    url: 'TermsOfGarrantyAdmin/Delete/' + record.data.Id,
    ...
    model: 'prada.page.models.TermsOfGarranty',
    readUrl: 'TermsOfGarrantyAdmin/AjaxRead',
    tbar: [{
        iconCls: 'icon-Add',
        text: 'جدید',
...
Ext.define('prada.page.views.TermsOfGarrantyForm', {
    extend: 'Ext.container.Container',
    rtl: false,
    layout: 'border',
    items: [{
        url: 'TermsOfGarrantyAdmin/Save',
        xtype: 'form',
        border: false,
        region: 'center',
        autoScroll: true,
...
Ext.define('prada.page.views.TermsOfGarranty.SearchBar', {
