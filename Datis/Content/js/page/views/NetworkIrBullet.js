Ext.define('prada.page.views.NetworkIrBullet', {
    extend: 'hussein.grid.Panel',
    requires: ['prada.page.models.NetworkIrBullet'],
    title: 'مدیریت Network Dome Camera',
    forceFit: true,
    searchbar: 'prada.page.views.NetworkIrBullet.SearchBar',
    columns: [
    {
        xtype: 'rownumberer'
    }, {
                    ...
                    fn: function (col, grid, record) {
                        return function (btn) {
                            if (btn == 'yes') {
                                Ext.Ajax.request({
                                    method: 'delete',
                                    url: 'NetworkIrBulletAdmin/Delete/' + record.data.Id,
    ...
    model: 'prada.page.models.NetworkIrBullet',
    readUrl: 'NetworkIrBulletAdmin/AjaxRead',
    tbar: [{
        iconCls: 'icon-Add',
        text: 'جدید',
...
Ext.define('prada.page.views.NetworkIrBullet.SearchBar', {
