Ext.define('prada.page.views.AHDPtz', {
    extend: 'hussein.grid.Panel',
    requires: ['prada.page.models.AHDPtz'],
    title: 'مدیریت Network Dome Camera',
    forceFit: true,
    searchbar: 'prada.page.views.AHDPtz.SearchBar',
    columns: [
    {
        xtype: 'rownumberer'
    }, {
        ...
        },
        {
            ...
            handler: function (grid, rowIndex, colIndex, actionItem, event, record) {
                Ext.create('Ext.window.Window', {
                    ...
                    modal: true,
                    constrain: true,
                    items: Ext.create('prada.page.views.AHDtzForm', {
                        values: record.data
                    ...
                    fn: function (col, grid, record) {
                        return function (btn) {
                            if (btn == 'yes') {
                                Ext.Ajax.request({
                                    method: 'delete',
                                    url: 'AHDPtzAdmin/Delete/' + record.data.Id,
    ...
    model: 'prada.page.models.AHDPtz',
    readUrl: 'AHDPtzAdmin/AjaxRead',
    tbar: [{
        iconCls: 'icon-Add',
        text: 'جدید',
...
Ext.define('prada.page.views.AHDtzForm', {
    extend: 'Ext.container.Container',
    rtl: false,
    layout: 'border',
    items: [{
        url: 'AHDPtzAdmin/Save',
        xtype: 'form',
        border: false,
        region: 'center',
        autoScroll: true,
     ...
     { xtype: 'textfield', fieldLabel: 'Effective Pixels', name: 'EffectivePixels' },
     { xtype: 'textfield', fieldLabel: 'Scanning System', name: 'ScanningSystem' },
     { xtype: 'textfield', fieldLabel: 'Electronic Shutter Speed', name: 'ElectronicShutterSpeed' },
     { xtype: 'textfield', fieldLabel: 'Minimum Illumination', name: 'MinIllumination' },
     ...
     { xtype: 'textfield', fieldLabel: 'Backlight Compensation', name: 'BacklightCompensation' },
     { xtype: 'textfield', fieldLabel: 'White Balance', name: 'WhiteBalance' },
     { xtype: 'textfield', fieldLabel: 'Gain Control', name: 'GainControl' },
     { xtype: 'textfield', fieldLabel: 'Noise Reduction', name: 'NoiseReduction' },
     { xtype: 'textfield', fieldLabel: 'Privacy Masking', name: 'PrivacyMasking' },
	 { xtype: 'textfield', fieldLabel: 'Digital Zoom', name: 'DigitalZoom' },
	 { xtype: 'textfield', fieldLabel: 'Defog', name: 'Defog' },
	 { xtype: 'textfield', fieldLabel: 'IR', name: 'IR' },
     { xtype: 'textfield', fieldLabel: 'Focal Length', name: 'FocalLength' },
     { xtype: 'textfield', fieldLabel: 'MaxA perture', name: 'MaxAperture' },
     { xtype: 'textfield', fieldLabel: 'Focus Control', name: 'FocusControl' },
     { xtype: 'textfield', fieldLabel: 'Angle Of View', name: 'AngleOfView' },
     { xtype: 'textfield', fieldLabel: 'Close Focus Distance', name: 'CloseFocusDistance' },
     { xtype: 'textfield', fieldLabel: 'Pan Tilt Range', name: 'PanTiltRange' },
     { xtype: 'textfield', fieldLabel: 'Manual Control Speed', name: 'ManualControlSpeed' },
     { xtype: 'textfield', fieldLabel: 'Preset Speed', name: 'PresetSpeed' },
     { xtype: 'textfield', fieldLabel: 'Preset', name: 'Preset' },
     { xtype: 'textfield', fieldLabel: 'PTZ Mode', name: 'PTZMode' },
     { xtype: 'textfield', fieldLabel: 'Spceed Setup', name: 'SpceedSetup' },
     { xtype: 'textfield', fieldLabel: 'Power Up Action', name: 'PowerUpAction' },
     { xtype: 'textfield', fieldLabel: 'Idle Motion', name: 'IdleMotion' },
     { xtype: 'textfield', fieldLabel: 'Time Task', name: 'TimeTask' },
     { xtype: 'textfield', fieldLabel: 'PTZ Protocol', name: 'PTZProtocol' },
     { xtype: 'textfield', fieldLabel: 'Video Compression', name: 'VideoCompression' },
     { xtype: 'textfield', fieldLabel: 'Resolution', name: 'Resolution' },
     { xtype: 'textfield', fieldLabel: 'FrameRate', name: 'FrameRate' },
     { xtype: 'textfield', fieldLabel: 'Bit Rate', name: 'BitRate' },
     { xtype: 'textfield', fieldLabel: 'Audio Compression', name: 'AudioCompression' },
     { xtype: 'textfield', fieldLabel: 'Interface', name: 'Interface' },
     { xtype: 'textfield', fieldLabel: 'Auto Tracking', name: 'AutoTracking' },
     { xtype: 'textfield', fieldLabel: 'IVS', name: 'IVS' },
     { xtype: 'textfield', fieldLabel: 'Tracking Trigger Mode', name: 'TrackingTriggerMode' },
     { xtype: 'textfield', fieldLabel: 'Tracking Trigger Event', name: 'TrackingTriggerEvent' },
     ...
     { xtype: 'textfield', fieldLabel: 'MaxUser Access', name: 'MaxUserAccess' },
     { xtype: 'textfield', fieldLabel: 'Smart Phone', name: 'SmartPhone' },
     { xtype: 'textfield', fieldLabel: 'Memory Slot', name: 'MemorySlot' },
     ...
     { xtype: 'textfield', fieldLabel: 'Working Environment', name: 'WorkingEnvironment' },
     { xtype: 'textfield', fieldLabel: 'Ingress Protection', name: 'IngressProtection' },
     { xtype: 'textfield', fieldLabel: 'Vandal Resistance', name: 'VandalResistance' },
    ...
    constructor: function (config) {
	 ...
	 { id: 'Defog', value: values.Defog },
	 { id: 'IR', value: values.IR },
     ...
     { id: 'CloseFocusDistance', value: values.CloseFocusDistance },
     { id: 'PanTiltRange', value: values.PanTiltRange },
     { id: 'ManualControlSpeed', value: values.ManualControlSpeed },
     { id: 'PresetSpeed', value: values.PresetSpeed },
     { id: 'Preset', value: values.Preset },
     { id: 'PTZMode', value: values.PTZMode },
     { id: 'SpeedSetup', value: values.SpeedSetup },
     { id: 'PowerUpAction', value: values.PowerUpAction },
     { id: 'IdleMotion', value: values.IdleMotion },
     { id: 'TimeTask', value: values.TimeTask },
     { id: 'PTZProtocol', value: values.PTZProtocol },
     ...
     { id: 'AutoTracking', value: values.AutoTracking },
     { id: 'IVS', value: values.IVS },
     { id: 'TrackingTriggerMode', value: values.TrackingTriggerMode },
     { id: 'TrackingTriggerEvent', value: values.TrackingTriggerEvent },
...
Ext.define('prada.page.views.AHDPtz.SearchBar', {
