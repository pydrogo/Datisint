Ext.define('prada.page.views.News', {
    extend: 'hussein.grid.Panel',
    requires: ['prada.page.models.News'],
    title: 'مدیریت اخبار',
    forceFit: true,
    searchbar: 'prada.page.views.News.SearchBar',
    columns: [
    {
        xtype: 'rownumberer', text: 'Row Number'
    }, {
        dataIndex: 'Title',
        text: 'Title'
    },
     ...
     },
      {
          ...
          handler: function (grid, rowIndex, colIndex, actionItem, event, record) {
              Ext.create('Ext.window.Window', {
                  title: 'افزودن عکس خبر',
                  height: 600,
                  width: 800,
                  layout: 'fit',
                  modal: true,
                  constrain: true,
                  items: Ext.create('prada.page.views.NewsImageUploader', {
                      values: record.data,
                      tableId: 99//for news
                  }),
                  listeners: {
          ...
          handler: function (grid, rowIndex, colIndex, actionItem, event, record) {
              Ext.create('Ext.window.Window', {
                  ...
                  modal: true,
                  constrain: true,
                  items: Ext.create('prada.page.views.NewsForm', {
                      values: record.data
                  ...
                  fn: function (col, grid, record) {
                      return function (btn) {
                          if (btn == 'yes') {
                              Ext.Ajax.request({
                                  method: 'delete',
                                  url: 'NewsAdmin/Delete/' + record.data.Id,
    ...
    plugins: [{
        ptype: 'rowexpander',
        rowBodyTpl: Ext.XTemplate('{Article}')
    }],
    model: 'prada.page.models.News',
    readUrl: 'NewsAdmin/AjaxRead',
    tbar: [{
        iconCls: 'icon-Add',
        text: 'جدید',
...
Ext.define('prada.page.views.NewsForm', {
    ...
    constructor: function (config) {
        ...
        if (config && config.values) {
            ...
            form.setValues([
                ...
                { id: 'NewsDate', value: values.NewsDate }
...
Ext.define('prada.page.views.News.SearchBar', {
