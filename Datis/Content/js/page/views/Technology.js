Ext.define('prada.page.views.Technology', {
    extend: 'hussein.grid.Panel',
    requires: ['prada.page.models.Technology'],
    title: 'مدیریت تکنولوژیها',
    forceFit: true,
    searchbar: 'prada.page.views.Technology.SearchBar',
    columns: [
    {
        text: 'ردیف',
        xtype: 'rownumberer'
    ...
    },
        {
            ...
            handler: function (grid, rowIndex, colIndex, actionItem, event, record) {
                Ext.create('Ext.window.Window', {
                    ...
                    modal: true,
                    constrain: true,
                    items: Ext.create('prada.page.views.TechnologyForm', {
                        values: record.data
                    ...
                    fn: function (col, grid, record) {
                        return function (btn) {
                            if (btn == 'yes') {
                                Ext.Ajax.request({
                                    method: 'delete',
                                    url: 'Technology/Delete/' + record.data.Id,
    ...
    model: 'prada.page.models.Technology',
    readUrl: 'Technology/AjaxRead',
    tbar: [{
        iconCls: 'icon-Add',
        text: 'جدید',
...
Ext.define('prada.page.views.TechnologyForm', {
...
Ext.define('prada.page.views.Technology.SearchBar', {
