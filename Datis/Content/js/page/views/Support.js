Ext.define('prada.page.views.Support', {
    extend: 'hussein.grid.Panel',
    requires: ['prada.page.models.Support'],
    title: 'مدیریت Analog BOX Camera',
    forceFit: true,
    searchbar: 'prada.page.views.Support.SearchBar',
    columns: [
    {
        ...
        handler: function (grid, rowIndex, colIndex, actionItem, event, record) {
            Ext.create('Ext.window.Window', {
                ...
                modal: true,
                constrain: true,
                items: Ext.create('prada.page.views.SupportForm', {
                    values: record.data
                ...
                fn: function (col, grid, record) {
                    return function (btn) {
                        if (btn == 'yes') {
                            Ext.Ajax.request({
                                method: 'delete',
                                url: 'SupportAdmin/Delete/' + record.data.Id,
    ...
    model: 'prada.page.models.Support',
    readUrl: 'SupportAdmin/AjaxRead',
    tbar: [{
        iconCls: 'icon-Add',
        text: 'جدید',
...
Ext.define('prada.page.views.SupportForm', {
    extend: 'Ext.container.Container',
    rtl: false,
    layout: 'border',
    items: [{
        url: 'SupportAdmin/Save',
        xtype: 'form',
        border: false,
        region: 'center',
        autoScroll: true,
...
Ext.define('prada.page.views.Support.SearchBar', {
