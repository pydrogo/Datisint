Ext.define('prada.page.views.AHDDome', {
    extend: 'hussein.grid.Panel',
    requires: ['prada.page.models.AHDDome'],
    title: 'مدیریت AHD Dome Camera',
    forceFit: true,
    searchbar: 'prada.page.views.AHDDome.SearchBar',
    columns: [
    {
        xtype: 'rownumberer'
    }, {
        ...
        },
        {
            ...
            handler: function (grid, rowIndex, colIndex, actionItem, event, record) {
                Ext.create('Ext.window.Window', {
                    ...
                    modal: true,
                    constrain: true,
                    items: Ext.create('prada.page.views.AHDDomeForm', {
                        values: record.data
                    ...
                    fn: function (col, grid, record) {
                        return function (btn) {
                            if (btn == 'yes') {
                                Ext.Ajax.request({
                                    method: 'delete',
                                    url: 'AHDDomeAdmin/Delete/' + record.data.Id,
    ...
    model: 'prada.page.models.AHDDome',
    readUrl: 'AHDDomeAdmin/AjaxRead',
    tbar: [{
        iconCls: 'icon-Add',
        text: 'جدید',
...
Ext.define('prada.page.views.AHDDomeForm', {
    extend: 'Ext.container.Container',
    rtl: false,
    layout: 'border',
    items: [{
        url: 'AHDDomeAdmin/Save',
        xtype: 'form',
        border: false,
        region: 'center',
        autoScroll: true,
      ...
      { xtype: 'textfield', fieldLabel: 'ProtectionLevel', name: 'ProtectionLevel' },
    ...
    constructor: function (config) {
      ...
      { id: 'ProtectionLevel', value: values.ProtectionLevel },
...
Ext.define('prada.page.views.AHDDome.SearchBar', {
