Ext.define('prada.page.views.Brochure', {
    extend: 'hussein.grid.Panel',
    requires: ['prada.page.models.Brochure'],
    title: 'مدیریت بروشور',
    forceFit: true,
    searchbar: 'prada.page.views.Brochure.SearchBar',
    columns: [
    {
        text: 'ردیف',
        xtype: 'rownumberer'
    ...
    },
        {
            ...
            handler: function (grid, rowIndex, colIndex, actionItem, event, record) {
                Ext.create('Ext.window.Window', {
                    ...
                    modal: true,
                    constrain: true,
                    items: Ext.create('prada.page.views.BrochureForm', {
                        values: record.data
                    ...
                    fn: function (col, grid, record) {
                        return function (btn) {
                            if (btn == 'yes') {
                                Ext.Ajax.request({
                                    method: 'delete',
                                    url: 'Brochure/Delete/' + record.data.Id,
    ...
    model: 'prada.page.models.Brochure',
    readUrl: 'Brochure/AjaxRead',
    tbar: [{
        iconCls: 'icon-Add',
        text: 'جدید',
...
Ext.define('prada.page.views.BrochureForm', {
...
Ext.define('prada.page.views.Brochure.SearchBar', {
