Ext.define('prada.page.views.NetworkDome', {
    extend: 'hussein.grid.Panel',
    requires: ['prada.page.models.NetworkDome'],
    title: 'مدیریت Network Dome Camera',
    forceFit: true,
    searchbar: 'prada.page.views.NetworkDome.SearchBar',
    columns: [
    {
        xtype: 'rownumberer'
    }, {
                    ...
                    fn: function (col, grid, record) {
                        return function (btn) {
                            if (btn == 'yes') {
                                Ext.Ajax.request({
                                    method: 'delete',
                                    url: 'NetworkDomeAdmin/Delete/' + record.data.Id,
    ...
    model: 'prada.page.models.NetworkDome',
    readUrl: 'NetworkDomeAdmin/AjaxRead',
    tbar: [{
        iconCls: 'icon-Add',
        text: 'جدید',
...
Ext.define('prada.page.views.NetworkDome.SearchBar', {
