Ext.define('prada.page.views.NetworkPtz', {
    extend: 'hussein.grid.Panel',
    requires: ['prada.page.models.NetworkPtz'],
    title: 'مدیریت Network Dome Camera',
    forceFit: true,
    searchbar: 'prada.page.views.NetworkPtz.SearchBar',
    columns: [
    {
        xtype: 'rownumberer'
    }, {
                    ...
                    fn: function (col, grid, record) {
                        return function (btn) {
                            if (btn == 'yes') {
                                Ext.Ajax.request({
                                    method: 'delete',
                                    url: 'NetworkPtzAdmin/Delete/' + record.data.Id,
    ...
    model: 'prada.page.models.NetworkPtz',
    readUrl: 'NetworkPtzAdmin/AjaxRead',
    tbar: [{
        iconCls: 'icon-Add',
        text: 'جدید',
...
Ext.define('prada.page.views.NetworkPtz.SearchBar', {
