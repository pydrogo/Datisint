Ext.define('prada.page.views.AnalogPtz', {
    extend: 'hussein.grid.Panel',
    requires: ['prada.page.models.AnalogPtz'],
    title: 'مدیریت Analog PTZ Camera',
    forceFit: true,
    searchbar: 'prada.page.views.AnalogPtz.SearchBar',
    columns: [
    {
        xtype: 'rownumberer'
    }, {
        ...
        },
        {
            ...
            handler: function (grid, rowIndex, colIndex, actionItem, event, record) {
                Ext.create('Ext.window.Window', {
                    ...
                    modal: true,
                    constrain: true,
                    items: Ext.create('prada.page.views.AnalogPtzForm', {
                        values: record.data
                    ...
                    fn: function (col, grid, record) {
                        return function (btn) {
                            if (btn == 'yes') {
                                Ext.Ajax.request({
                                    method: 'delete',
                                    url: 'AnalogPtzAdmin/Delete/' + record.data.Id,
    ...
    model: 'prada.page.models.AnalogPtz',
    readUrl: 'AnalogPtzAdmin/AjaxRead',
    tbar: [{
        iconCls: 'icon-Add',
        text: 'جدید',
...
Ext.define('prada.page.views.AnalogPtzForm', {
    extend: 'Ext.container.Container',
    rtl: false,
    layout: 'border',
    items: [{
        url: 'AnalogPtzAdmin/Save',
        xtype: 'form',
        border: false,
        region: 'center',
        autoScroll: true,
        ...
        , {
         ...
         {
             xtype: 'textfield',
             fieldLabel: 'Scanning System',
             name: 'ScanningSystem'
         },
          {
              xtype: 'textfield',
              fieldLabel: 'Electronic Shutter Speed',
...

        {
         ...
         , {
             ...
             xtype: 'textfield',
             fieldLabel: 'Focus Control',
             name: 'FocusControl'
         }, {
             xtype: 'textfield',
             fieldLabel: 'Angle Of View',
             name: 'AngleOfView'
         }, {
             xtype: 'textfield',
             fieldLabel: 'Close Focus Distance',
             name: 'CloseFocusDistance'
         }, {
             xtype: 'textfield',
             fieldLabel: 'Pan Tilt Range',
             name: 'PanTiltRange'
         }, {
             xtype: 'textfield',
             fieldLabel: 'Manual Control Speed',
             ...
             xtype: 'textfield',
             fieldLabel: 'Speed Setup',
             name: 'SpeedSetup'
         }, {
             xtype: 'textfield',
             fieldLabel: 'Power Up Action',
             name: 'PowerUpAction'
         }, {
             xtype: 'textfield',
             fieldLabel: 'Idle Motion',
             name: 'IdleMotion'
         }, {
             xtype: 'textfield',
             fieldLabel: 'Time Task',
             name: 'TimeTask'
         }, {
             xtype: 'textfield',
             fieldLabel: 'Protocol',
...
Ext.define('prada.page.views.AnalogPtz.SearchBar', {
