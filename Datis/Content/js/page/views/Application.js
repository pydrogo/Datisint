Ext.define('prada.page.views.Application', {
    extend: 'hussein.grid.Panel',
    requires: ['prada.page.models.Application'],
    title: 'نرم افزارهای کاربردی',
    forceFit: true,
    searchbar: 'prada.page.views.Application.SearchBar',
    columns: [
    {
        text: 'ردیف',
        xtype: 'rownumberer'
    ...
    },
        {
            ...
            handler: function (grid, rowIndex, colIndex, actionItem, event, record) {
                Ext.create('Ext.window.Window', {
                    ...
                    modal: true,
                    constrain: true,
                    items: Ext.create('prada.page.views.ApplicationForm', {
                        values: record.data
                    ...
                    fn: function (col, grid, record) {
                        return function (btn) {
                            if (btn == 'yes') {
                                Ext.Ajax.request({
                                    method: 'delete',
                                    url: 'Application/Delete/' + record.data.Id,
    ...
    model: 'prada.page.models.Application',
    readUrl: 'Application/AjaxRead',
    tbar: [{
        iconCls: 'icon-Add',
        text: 'جدید',
...
Ext.define('prada.page.views.ApplicationForm', {
...
Ext.define('prada.page.views.Application.SearchBar', {
