Ext.define('prada.page.views.NetworkBox', {
    extend: 'hussein.grid.Panel',
    requires: ['prada.page.models.NetworkBox'],
    title: 'مدیریت Network BOX Camera',
    forceFit: true,
    searchbar: 'prada.page.views.NetworkBox.SearchBar',
    columns: [
    {
        xtype: 'rownumberer'
    }, {
        ...
        },
        {
            ...
            handler: function (grid, rowIndex, colIndex, actionItem, event, record) {
                Ext.create('Ext.window.Window', {
                    ...
                    modal: true,
                    constrain: true,
                    items: Ext.create('prada.page.views.NetworkBoxForm', {
                        values: record.data
                    ...
                    fn: function (col, grid, record) {
                        return function (btn) {
                            if (btn == 'yes') {
                                Ext.Ajax.request({
                                    method: 'delete',
                                    url: 'NetworkBoxAdmin/Delete/' + record.data.Id,
    ...
    model: 'prada.page.models.NetworkBox',
    readUrl: 'NetworkBoxAdmin/AjaxRead',
    tbar: [{
        iconCls: 'icon-Add',
        text: 'جدید',
...
Ext.define('prada.page.views.NetworkBoxForm', {
    extend: 'Ext.container.Container',
    rtl: false,
    layout: 'border',
    items: [{
        url: 'NetworkBoxAdmin/Save',
        xtype: 'form',
        border: false,
        region: 'center',
        autoScroll: true,
...
Ext.define('prada.page.views.NetworkBox.SearchBar', {
