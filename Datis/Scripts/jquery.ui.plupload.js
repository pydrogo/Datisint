			...
			'<div class="ui-widget-content plupload_container">' +
				'<div class="ui-state-default ui-widget-header plupload_header">' +
					'<div class="plupload_header_content">' +
						...
						'<div class="plupload_header_title">' + _("انتخاب فایل ها") + '</div>' +
						'<div class="plupload_header_text">' + _("فایل های خود را انتخاب کنید") + '</div>' +
						'<div class="plupload_view_switch">' +
							'<input type="radio" id="'+obj.id+'_view_list" name="view_mode_'+obj.id+'" checked="checked" /><label class="plupload_button" for="'+obj.id+'_view_list" data-view="list">' + _('لیست') + '</label>' +
							'<input type="radio" id="'+obj.id+'_view_thumbs" name="view_mode_'+obj.id+'" /><label class="plupload_button"  for="'+obj.id+'_view_thumbs" data-view="thumbs">' + _('بندانگشتی') + '</label>' +
						'</div>' +
					'</div>' +
				'</div>' +
				...
				'<tr>' +
					'<td class="plupload_cell plupload_file_name">' + _('نام فایل') + '</td>' +
					'<td class="plupload_cell plupload_file_status">' + _('وضعیت') + '</td>' +
					'<td class="plupload_cell plupload_file_size">' + _('سایز') + '</td>' +
					'<td class="plupload_cell plupload_file_action">&nbsp;</td>' +
				'</tr>' +
				'</table>' +

				'<div class="plupload_content">' +
					'<div class="plupload_droptext">' + _("فایل ها را اینجا دراپ کنید") + '</div>' +
				...
				'<tr>' +
					'<td class="plupload_cell plupload_file_name">' +
						'<div class="plupload_buttons"><!-- Visible -->' +
							'<a class="plupload_button plupload_add">' + _("افزودن فایل") + '</a>&nbsp;' +
							'<a class="plupload_button plupload_start">' + _("شروع آپلود") + '</a>&nbsp;' +
							'<a class="plupload_button plupload_stop plupload_hidden">'+_("توقف آپلود") + '</a>&nbsp;' +
						'</div>' +
	...
	*/
	...
	_handleState: function() {
		...
		if (up.total.queued === 0) {
			$('.ui-button-text', this.browse_button).html(_('افزودن فایل'));
		} else {
			$('.ui-button-text', this.browse_button).html(o.sprintf(_('%d فایل در صف'), up.total.queued));
		}
